...
def printMsgsInBagFile(args):
    ...
    for topic, msg, t in bag_in.read_messages(args.topics_to_read):
        ...
        #print("size:"+str(sys.getsizeof(msg)))
        if len(str(msg))>2100:
            #print(str(msg)[0:10])
            #print(re.split("data:",str(msg))[0][0:10])
            print(re.split("data:",str(msg))[1][0:10])
            #print(re.split("data:",str(msg))[2][0:10])
            #print("...")
            #print(str(msg)[-1000:-1])
        else:
            print(msg)
        ...
        #print(msg)
        #"""
        totalsize+=sys.getsizeof(str(msg))
        #print(sys.getsizeof(msg.cloud))
